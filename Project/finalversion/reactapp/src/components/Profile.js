                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            <div className="text-center">
                                <img style={{width:'70%'}} src="//placehold.it/100" className="avatar img-circle" alt="avatar"/>
                                    <h5>Upload a new photo in ".jpg" format</h5>
                                    <input type="file" id="ProfileInput" accept=".jpg, .png" className="btn btn-primary" style={{fontSize:'12px',fontFamily:'Helvetica'}}/>
                            </div>
                        </div>
